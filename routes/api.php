...
use App\Http\Controllers\Api\MiembrosController;
use App\Http\Controllers\Api\ConfiguracionesController;
use App\Http\Controllers\Api\EstudiosController;
use App\Http\Controllers\Api\MinisteriosController;
use App\Http\Controllers\Api\CelulasController;
use App\Http\Controllers\Api\AgendasController;
use App\Http\Controllers\Api\ConversionesController;
...
|
*/
Route::get('/llamame', [RegistrosController::class, 'llamame'])->name('llamame');
